...
trait AwareTrait
{
    ...
    public function setFabricationSpecificationHandlerFactory(FactoryInterface $HandlerFactory): self
    {
        if ($this->hasFabricationSpecificationHandlerFactory()) {
            throw new \LogicException('FabricationSpecificationHandlerFactory is already set.');
        }
    ...
    {
        if (!$this->hasFabricationSpecificationHandlerFactory()) {
            throw new \LogicException('FabricationSpecificationHandlerFactory is not set.');
        }
