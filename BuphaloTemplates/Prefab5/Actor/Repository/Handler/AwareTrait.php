...
trait AwareTrait
{
    ...
    public function setActorMapRepositoryHandler(\Neighborhoods\BuphaloTemplateTree\Template\Actor\Map\Repository\HandlerInterface $ActorMapRepositoryHandler) : self
    {
    ...
    protected function getActorMapRepositoryHandler() : \Neighborhoods\BuphaloTemplateTree\Template\MV1\Address\Map\Repository\HandlerInterface
    {
        if (!$this->hasActorMapRepositoryHandler()) {
