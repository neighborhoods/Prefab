...
trait AwareTrait
{
    ...
    public function setActorMapRepositoryHandler(\Neighborhoods\Buphalo\Template\Template\Actor\Map\Repository\HandlerInterface $ActorMapRepositoryHandler) : self
    {
    ...
    protected function getActorMapRepositoryHandler() : \Neighborhoods\Buphalo\Template\Template\MV1\Address\Map\Repository\HandlerInterface
    {
        if (!$this->hasActorMapRepositoryHandler()) {
