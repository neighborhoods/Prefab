...
namespace Neighborhoods\Prefab\ActorConfiguration\Actor\Repository;

use Neighborhoods\Prefab\AnnotationProcessorRecordInterface;

interface HandlerInterface
{
    public const ACTOR_KEY = '<PrimaryActorName>/Repository/HandlerInterface.php';
    public const TEMPLATE_PATH = 'PrimaryActorName/Repository/HandlerInterface.php';
    public const KEY_HANDLER_INTERFACE_CONSTANTS = 'Neighborhoods\Prefab\AnnotationProcessor\Actor\Repository\HandlerInterface-CONSTANTS';
