...
namespace Neighborhoods\Prefab\AnnotationProcessorRecord\StaticContextRecord\Actor\Map\Repository\HandlerServiceFile\ProjectNamespaceSearchCriteria;
...
class Builder implements BuilderInterface
{
    ...
    {
        $namespace = '@' . $this->getBuildConfiguration()->getVendorName() . '\PROJECTNAME\Prefab5\SearchCriteria\ServerRequest\Builder\FactoryInterface';
