...
namespace Neighborhoods\Prefab\AnnotationProcessorRecord\StaticContextRecord\Actor\Map\Builder\BuildForInsertMethodIdentityField;
...
class Builder implements BuilderInterface
{
    ...
    public function build() : array
    {
        ...
        return [
            Map\BuilderBuildForInsertMethod::CONTEXT_KEY_IDENTITY_FIELD => $this->getBuildConfiguration()->getDaoIdentityField()
        ];
    }
