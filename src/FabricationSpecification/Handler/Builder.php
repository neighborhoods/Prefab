...
class Builder implements BuilderInterface
{
    ...
    protected $actorCollection = [
        ActorConfiguration\Actor\Repository\Handler::class,
        ActorConfiguration\Actor\Repository\HandlerInterface::class,
        ActorConfiguration\Actor\Repository\HandlerServiceFile::class,
    ];
